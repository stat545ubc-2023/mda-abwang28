...
```
The class of the dataset is "tbl_df", "tbl" and "data.frame". Variable classes within the table include character and double. There are 10,032 rows, and there are 22 variables.
...
```
The class of the dataset is "tbl_df", "tbl" and "data.frame". Variable classes within the table include date, character and double.  There are 146,611 rows, and there are 20 variables.
...
```
The class of the dataset is "tbl_df", "tbl" and "data.frame". Variable classes within the table include character and double. There are 3455 rows, and there are 37 variables.
...
```
The class of the dataset is "spec_tbl_df", "tbl_df", "tbl" and "data.frame". Variable classes within the table include date, character and double. There are 20,680 rows, and there are 14 variables.
